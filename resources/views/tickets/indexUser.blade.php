        ...
        <div class="col-md-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- when user want to create any ticket for click on this button -->
                        <div class="row pull-left mt-20 ">
                            <div class="col-lg-12 margin-tb">
                                <div class="">
                                    <a class="btn btn-success" href="{{route('tickets.create')}}">Generate Ticket</a>
                                </div>
                            </div>
                        </div>
                        <br>
