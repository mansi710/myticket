                        ...
                        <div class="col-lg-12 margin-tb">
                            <div class="">
                                <form action="{{ route('tickets.index') }}" method="GET">
                                    ...
                                    <input type="text" name="searchId"  placeholder="Serach By Ticket Id" />
                                    <input type="text" name="searchName"  placeholder="Serach By Ticket Name" />
                                    <input type="text" name="searchStatus"   placeholder="Serach By Ticket Status" />
                                    <input type="text" name="searchPriority" placeholder="Serach By Ticket Priority" />
                                    <input type="text" name="searchMessage"  placeholder="Serach By Ticket Message" />
